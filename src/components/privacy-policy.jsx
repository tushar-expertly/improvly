    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            At Improvly, we are dedicated to safeguarding your privacy and
            ...
            existing agreements directly established between you and Improvly.
          ...
          <p className="mb-4">
            At Improvly, we will only request personal information when it is
          ...
          <p className="mb-4">
            In the event that Improvly invites you to complete and submit an
          ...
          <p className="mb-4">
            It's important to note that while Improvly may track a visitor's
          ...
          <p className="mb-4">
            The purposes for which Improvly may utilize your personal
          ...
          <p className="mb-4">
            If you wish to be removed from any Improvly distribution list,
          ...
          <p className="mb-4">
            ...
            Improvly, you may receive telephone calls from us regarding new
          ...
          <p className="mb-4">
            The Improvly website may contain links to external websites,
            ...
            are not governed by Improvly's privacy policy. Improvly has no
          ...
          <p className="mb-4">
            ...
            Improvly's privacy practices and does not extend to the privacy
            policies or practices of third-party websites or features. Improvly
          ...
          <p className="mb-4">
            ...
            paramount at Improvly. We have implemented robust measures to
          ...
          <p className="mb-4">
            At Improvly, we remain committed to upholding the highest standards
          ...
          <p className="mb-4">
            ...
            Improvly remains fully compliant with the EU-US Privacy Shield
          ...
          <p className="mb-4">
            At Improvly, we are committed to maintaining the highest standards
          ...
          <p className="mb-4">
            Improvly is mandated to adhere to specific procedures when
          ...
          <p className="mb-4">
            In accordance with the Privacy Shield Principles, Improvly is
          ...
          <p className="mb-4">
            Improvly is subject to the investigative and enforcement authority
          ...
          <p className="mb-4">
            Improvly reserves the right to modify or supplement this Privacy
            Policy at its discretion. We encourage you to periodically review
            this section of Improvly’s website to stay informed of any updates.
